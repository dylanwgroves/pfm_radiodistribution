...
/* Set table name ______________________________________________________________*/
	...
	local tablename "${rd_clean_tables}/pfm_rd_tables_results_open_marry.tex"
	
	
/* Load Data ___________________________________________________________________*/	

	import excel "${rd_tables}/pfm_rd_analysis_main_all_sb.xlsx", sheet("open_marry") firstrow clear
...
/* Variable lables _____________________________________________________________*/
	...
	replace variablelabel = "Index" if variable == 						"open_kidmarry_index"
	replace variablelabel = "Tribe" if variable == 						"open_kidmarry_difftribe"
	replace variablelabel = "Religion" if variable == 					"open_kidmarry_diffrelig"
	replace variablelabel = "Country" if variable == 					"open_kidmarry_difftz"
...
texdoc write   								&\multicolumn{2}{c}{} &	\multicolumn{2}{c}{Crime Perception} &	\multicolumn{2}{c}{Risk Perception}	&	\multicolumn{2}{c}{Avoid}	\\ \cmidrule(r){4-5} \cmidrule(r){6-7} \cmidrule(r){8-9}		 
